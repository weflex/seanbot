...
const getMasksFromCommentBody = require('./function').getMasksFromCommentBody;
const getPrMsgFormUrl = require('./function').getPrMsgFormUrl;
const getBranchMsgFormHtmlUrl = require('./function').getBranchMsgFormHtmlUrl;
